...
[code lang="shell"] $ file test.csv  
test.csv: Composite Document File V2 Document, Little Endian, Os: Windows, Version 5.2, Code page: 1251, Author: , Last Saved By: , Name of Creating Application: Microsoft Excel, Create Time/Date: Sat Apr 28 10:33:01 2018, Last Saved Time/Date: Sat Apr 28 10:45:37 2018, Security: 0[/code]
...
[code lang="shell"] $ sudo dnf install unoconv[/code]

[code lang="shell"] $ mv test.csv test  
$ unoconv --format=ods test[/code]
